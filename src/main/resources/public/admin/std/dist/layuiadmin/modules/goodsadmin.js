...
;layui.define(["table", "form"], function (e) {
    ...
    i.render({
        ...
        url: "/layuiadmin/goods/getAllGoods",
        cols: [[{type: "checkbox", fixed: "left"},
            {field: "categoryId", width: 100, title: "分类ID", sort: !0},
            {
                field: "goodsSn",
                title: "商品编号",
                minWidth: 100
            }, {field: "name", title: "商品名", width: 300},
            {field: "retailPrice", title: "实际价格", width: 100},
        ...
        if ("del" === e.event) layer.prompt({formType: 1, title: "敏感操作，请验证口令"}, function (t, i) {
            ...
            layer.open({
                type: 2,
                title: "编辑商品",
                content: "../../../views/user/user/goodsform.html",
                maxmin: !0,
                area: ["500px", "450px"],
                btn: ["确定", "取消"],
                yes: function (e, t) {
