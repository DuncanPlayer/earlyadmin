...
;layui.define(["table", "form"], function (t) {
    ...
    i.render({
        ...
        url: "/layuiadmin/comment/commentList",
        cols: [[{type: "checkbox", fixed: "left"}, {field: "id", width: 100, title: "评价Id", sort: !0}, {
            field: "valueId",
            title: "商品id",
            minWidth: 100
        }, {field: "content", title: "内容",width: 300}, {field: "dateStr", title: "评价事件",width:250}, {
            title: "操作",
            minWidth: 150,
            align: "center",
            fixed: "right",
        ...
        cols: [[{type: "checkbox", fixed: "left"}, {field: "id", width: 100, title: "评价Id", sort: !0}, {
            ...
            title: "商品id",
            minWidth: 100
        }, {field: "content", title: "内容",width: 300}, {field: "dateStr", title: "评价时间",width:250}, {
            title: "操作",
            minWidth: 150,
            align: "center",
            fixed: "right",
