...
import net.messi.earlyadmin.pojo.NideshopCommentExample;
...
public interface NideshopCommentMapper {
    ...
    List<NideshopComment> findCommentByLimit(@Param("page") Integer page,@Param("limitSize") Integer limitSize);
}