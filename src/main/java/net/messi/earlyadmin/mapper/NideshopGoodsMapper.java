...
import net.messi.earlyadmin.pojo.NideshopGoodsExample;
...
public interface NideshopGoodsMapper {
    ...
    List<NideshopGoods> findAllGoodsByLimit(@Param("page") Integer page,@Param("limitNum") Integer limitNum);

    List<NideshopGoods> findGoodsByOrderId(@Param("orderId") Integer orderId);
